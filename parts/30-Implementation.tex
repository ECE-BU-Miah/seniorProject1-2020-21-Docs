...
\end{table}
In order to send data between the different processes, the topic, method, and data are delimited in a particular way. This method is shown below as follows
\begin{verbatim}
    topic method/args
\end{verbatim}
