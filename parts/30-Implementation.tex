...
MQ asynchronous messaging library\todo{citation here}. Essentially, this library
...
\end{figure}
%
\todo[inline]{Figures are cited in the text}
...
\end{figure}
%
\todo[inline]{Figures are not cited in the text}
...
be called with the data parameters \replace{like}{, such as} power state and
