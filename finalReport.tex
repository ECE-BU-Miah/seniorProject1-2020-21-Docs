...
\input{parts/20-iBEMSArchitecture}
\input{parts/30-Implementation}
\input{parts/40-ExperimentalResults}
\input{parts/50-Conclusion}
...
\input{parts/A-Installation}
\input{parts/B-HowToRun}
\input{parts/C-WemoSetup}
\input{parts/D-EmbeddedComputerSetup}
